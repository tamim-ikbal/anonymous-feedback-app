...
<head>
    ...
    <title> Home  - Anonymous Feedback App</title>
                ...
                <div class="divide-y divide-gray-300/50">
                    <div class="space-y-6 py-8 text-base leading-7 text-gray-600 px-12">
                        ...
                        <div class="flex justify-center">
                            <img class="max-h-72" src="<?php echo asset('assets/images/letter.png'); ?>" alt="">
                        </div>
                    </div>
                    <div class="pt-8 text-base font-semibold leading-7">
                        <p class="text-gray-900">Sounds interesting?</p>
                        <p>
                            <a href="<?php echo auth()::check() ? uri('/dashboard') : uri('/login'); ?>" class="text-sky-500 hover:text-sky-600">Let's start!</a>
                        </p>
                    </div>
                </div>
            </div>
