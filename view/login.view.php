            ...
            <div class="mx-auto max-w-xl">
                <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    ...
                    <div class="mt-10 mx-auto w-full max-w-xl">
                        <form class="space-y-6" action="<?php echo uri('/login'); ?>" method="POST">
                            <div>
                        ...
                        <p class="mt-10 text-center text-sm text-gray-500">
                            Not a member?
                            <a href="<?php echo uri('/register'); ?>" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Register now!</a>
                        </p>
                    </div>
                </div>
            </div>
